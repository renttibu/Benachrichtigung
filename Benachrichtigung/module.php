        ...
        switch ($TemplateType) {
            case 0: # alarm zone control
                ...
                $armedOpenWindow = [
                    ...
                    'Title'                               => $config['Location'],
                    'TriggeringDetector'                  => 0,
                    'MessageText'                         => 'Alarmanlage scharf, jedoch sind noch Türen oder Fenster offen!',
                    'UseTimestamp'                        => true,
                    'UseWebFrontNotification'             => false,
                    'WebFrontNotificationTextSymbol'      => '"\ud83d\udfe1"',
                    'Icon'                                => 'Warning',
            ...
            case 1: # alarm zone
                ...
                $armedOpenWindow = [
                    ...
                    'Title'                               => $config['AlarmZoneName'],
                    'TriggeringDetector'                  => 0,
                    'MessageText'                         => $config['SystemName'] . ' scharf, jedoch sind noch Türen oder Fenster offen!',
                    'UseTimestamp'                        => true,
                    'UseWebFrontNotification'             => false,
                    'WebFrontNotificationTextSymbol'      => '"\ud83d\udfe1"',
                    'Icon'                                => 'Warning',
